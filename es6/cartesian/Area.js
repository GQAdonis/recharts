  ...
  return /*#__PURE__*/React.createElement(AreaLabelListProvider, {
    ...
    if (prevPoints) {
      ...
      if (isNumber(baseLine)) {
        ...
        stepBaseLine = interpolate(_previousNumberBaseLine, 0, t);
      } else {
...
function AreaImpl(props) {
  ...
  var _ref0 = (_useAppSelector = useAppSelector(state => selectArea(state, props.id, isPanorama))) !== null && _useAppSelector !== void 0 ? _useAppSelector : {},
    points = _ref0.points,
...
export function computeArea(_ref1) {
