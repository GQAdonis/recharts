...
function AreaWithAnimation(_ref8) {
  var needClip = _ref8.needClip,
    clipPathId = _ref8.clipPathId,
    props = _ref8.props,
    previousPointsRef = _ref8.previousPointsRef,
    previousBaselineRef = _ref8.previousBaselineRef;
  ...
  return /*#__PURE__*/React.createElement(AreaLabelListProvider, {
    ...
    if (prevPoints) {
      ...
      if ((0, _DataUtils.isNumber)(baseLine)) {
        ...
        stepBaseLine = (0, _DataUtils.interpolate)(previousNumberBaseLine, baseLine, t);
        ...
        stepBaseLine = (0, _DataUtils.interpolate)(_previousNumberBaseLine, 0, t);
      } else {
...
function RenderArea(_ref9) {
  var needClip = _ref9.needClip,
    clipPathId = _ref9.clipPathId,
    props = _ref9.props;
  /*
...
function AreaImpl(props) {
  ...
  var _ref0 = (_useAppSelector = (0, _hooks.useAppSelector)(state => (0, _areaSelectors.selectArea)(state, props.id, isPanorama))) !== null && _useAppSelector !== void 0 ? _useAppSelector : {},
    points = _ref0.points,
    isRange = _ref0.isRange,
    baseLine = _ref0.baseLine;
...
function computeArea(_ref1) {
  var _ref1$areaSettings = _ref1.areaSettings,
    connectNulls = _ref1$areaSettings.connectNulls,
    itemBaseValue = _ref1$areaSettings.baseValue,
    dataKey = _ref1$areaSettings.dataKey,
    stackedData = _ref1.stackedData,
    layout = _ref1.layout,
    chartBaseValue = _ref1.chartBaseValue,
    xAxis = _ref1.xAxis,
    yAxis = _ref1.yAxis,
    displayedData = _ref1.displayedData,
    dataStartIndex = _ref1.dataStartIndex,
    xAxisTicks = _ref1.xAxisTicks,
    yAxisTicks = _ref1.yAxisTicks,
    bandSize = _ref1.bandSize;
