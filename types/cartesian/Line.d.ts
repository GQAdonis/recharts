...
import { ActiveDotType, ActiveShape, AnimationDuration, EasingInput, CartesianLayout, DataConsumer, DataProvider, DotType, LegendType, TickItem, TooltipType } from '../util/types';
...
export declare const defaultLineProps: {
    ...
    readonly shape: React.FC<CurveProps>;
