 ...
 * @since 3.9
 */
export declare function interpolate(start: number | null | undefined, end: number, t: number): number;
export declare function interpolate(start: number | null | undefined, end: null, t: number): null;
export declare function interpolate(start: number | null | undefined, end: undefined, t: number): undefined;
export declare function interpolate(start: number | null | undefined, end: number | null, t: number): number | null;
export declare function interpolate(start: number | null | undefined, end: number | undefined, t: number): number | undefined;
export declare function interpolate(start: number | null | undefined, end: number | null | undefined, t: number): number | null | undefined;
