 ...
 */
export declare function Shape<PropsType extends object, ElementType extends SVGElement = SVGElement>({ option, DefaultShape, shapeProps, activeClassName, inActiveClassName, }: ShapeProps<PropsType, ElementType>): React.JSX.Element;
export {};
